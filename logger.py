...
class Logger:
    ...
    def log(self, delta, greedy, sample, val):
        if val:
            ...
            self.temp_val_greedy_rewards.append([greedy['rouge2'][2], greedy['rougeL'][2]])
            self.temp_val_sample_rewards.append([sample['rouge2'][2], sample['rougeL'][2]])
        else:
            self.temp_train_delta_rewards += delta.tolist()
            self.temp_train_greedy_rewards.append([greedy['rouge2'][2], greedy['rougeL'][2]])
            self.temp_train_sample_rewards.append([sample['rouge2'][2], sample['rougeL'][2]])
